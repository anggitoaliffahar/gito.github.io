...
const projects = [
  {
    title: "Project Skecthup",
    cardImage: "assets/images/sk_tugas_mbak_lutvi.jpg",
    description: "A house that made by sketchup.",
    tagimg: "https://hubs.mozilla.com//8VURsc4",
    Previewlink: "https://hubs.mozilla.com/scenes/8VURsc4",
  },
  {
    title: "asdasdasd",
    cardImage: "",
          ...
          <div class="wrapper" style="background: url() center / cover no-repeat;">
            <div class="header">
              <div class="img-header">
                <img src="${cardImage}" width="100%" length="150%">
              </div>
            </div>
            <div class="data">
              <div class="content">
