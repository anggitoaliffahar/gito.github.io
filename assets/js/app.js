...
<a class="navbar-brand" href="index.html">Anggito Alif </a>
...
<div class="collapse navbar-collapse " id="navbarSupportedContent">
  <ul class="navbar-nav ml-auto" id = "navbar-content">
   ...
   <li class="nav-item nav-item-hover"><a class="nav-link" href="https://anggitoalifseaqis.blogspot.com/2023/06/about-me.html" target="_blank">Blogs</a></li>
   <li class="nav-item">
...
let footer = $(`
<footer class="footer sticky-bottom text-middle"  style="background-color:#2b2a2a;">
  <div class="p-4">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class=" col-md-12 mb-4 mb-md-0 form-comtainer">
          <div class="form-center">
             <div class="form-center">
                <h6 class="display-center text-center"> Get in Touch </h6>
              </div>
              </div>
            </div>
          </div>
    ...
    <a class="social-button twitter" href="https://twitter.com/alipkuproy" target="_blank">
    <!-- SVG code for twitter icon -->
    <svg class="twitter-icon-footer" version="1.1" id="Layer_1" xmlns="https://twitter.com/alipkuproy"
        xmlns:xlink="https://twitter.com/alipkuproy" x="0px" y="0px" viewBox="0 0 500 500" enable-background="new 0 0 500 500"
        xml:space="preserve">
        <!-- bird body -->
    ...
    <a class="social-button linkedin" href="https://www.linkedin.com//in/anggito-alif-129903261/" target="_blank" >
    <!-- svg code for linkedin icon -->
      <svg class="linkedin-icon-footer" xmlns="https://www.linkedin.com//in/anggito-alif-129903261/" width="35" viewBox="0 0 24 24" fill="#0e76a8"
    ...
    <a class="social-button instagram" href="https://www.instagram.com/anggitoalif3004/" target="_blank" >
    ...
    <a class="social-button github" href="https://github.com/anggitoaliffahar" target="_blank">
